...
LatticeWorld::LatticeWorld(int n, DataFrame ing_eg, std::string taufile, int iter, double r, std::string file) {
  ...
  // Set ingress and egress rates, and also voter rate, from the infile, now a DataFrame in ing_eg
